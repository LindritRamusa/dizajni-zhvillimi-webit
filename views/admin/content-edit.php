<div class="admin-form-container">
    ...
    <form method="POST" class="admin-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($block['title'] ?? ''); ?>">
        </div>
        <div class="form-group">
            <label for="content">Përmbajtja</label>
            <textarea id="content" name="content" rows="6"><?php echo htmlspecialchars($block['content'] ?? ''); ?></textarea>
        </div>
        <div class="form-group">
            <label for="image">Ikona / imazh (emoji ose emër skedari)</label>
            <input type="text" id="image" name="image" value="<?php echo htmlspecialchars($block['image'] ?? ''); ?>">
        </div>
        <div class="form-group">
            <label for="display_order">Renditja (numër)</label>
            <input type="number" id="display_order" name="display_order" value="<?php echo (int)($block['display_order'] ?? 0); ?>">
        </div>
